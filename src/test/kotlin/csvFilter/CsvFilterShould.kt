...
class CsvFilterShould {
    ...
    fun tax_identification_fields_are_mutually_exclusive(){
        val invoiceLine = "1,02/05/2019,1000,810,19,,ACER Laptop,B76430134,50584422Q"
    ...
    fun there_must_be_at_least_one_tax_identification_for_the_invoice(){
        val invoiceLine = "1,02/05/2019,1000,810,19,,ACER Laptop,,"
    ...
    fun lines_repeated_are_filtered(){
        ...
        val result = CsvFilter().filter(listOf(headerLine, invoiceLine, invoiceLine))
